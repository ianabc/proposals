module PeopleHelper
  ...
  def country_options
    countries = [
      ...
      %w[Sweden Sweden], %w[Switzerland Switzerland], %w[Syria Syria], %w[Tajikistan Tajikistan], %w[Taiwan Taiwan],
      %w[Tanzania Tanzania], %w[Thailand Thailand], %w[Timor-Leste Timor-Leste], %w[Togo Togo], %w[Tonga Tonga],
